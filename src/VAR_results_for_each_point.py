...
# Read csv
pixel_df4 = pd.read_csv('/media/kursat/TOSHIBA EXT8/projects/satellite/YENI/data/100points_pixelIntensitiesB4.csv')
pixel_df3 = pd.read_csv('/media/kursat/TOSHIBA EXT8/projects/satellite/YENI/data/100points_pixelIntensitiesB3.csv')
pixel_df2 = pd.read_csv('/media/kursat/TOSHIBA EXT8/projects/satellite/YENI/data/100points_pixelIntensitiesB2.csv')
iou_df = pd.read_csv('/media/kursat/TOSHIBA EXT8/projects/satellite/YENI/data/100points_iou.csv')
scores_df = pd.read_csv('/media/kursat/TOSHIBA EXT8/projects/satellite/YENI/data/100points_scores.csv')

# Read Json
json_path = '/media/kursat/TOSHIBA EXT8/projects/satellite/YENI/data/100points_probabilities.json'
...
for index in range(100):
    ...
    concat = pd.concat([pixel_b4, pixel_b3, pixel_b2, iou, scores,
                    class1_df, class2_df, class3_df, class4_df, class5_df, class6_df], axis=1)
...
with open('/media/kursat/TOSHIBA EXT8/projects/satellite/YENI/data/VAR_results.json', 'w') as file:
    json.dump(data, file)
